...
- [x] Add the user-provided credits object to every successful player JSON response.
- [x] Preserve credits as the final serialized key in successful player JSON responses.
- [x] Perform and verify a BD-region lookup for UID 2769409057.
